...
<div>
  ...
  <p>
    Первое его значение- также «собираться». Но, в отличие от 想, говорящий не просто хочет поехать куда-то, но уже запланировал маршрут и
    купил билет.
  </p>
  ...
  <br />
  <p>
    Обратите внимание, что часто отрицательные и утвердительные формы модальных глаголов не совпадают по значению. Например, 不要
...
export const glossary: IGlossaryContent[] = [{ id: '1', title: 'Модальные глаголы', hsk: 1, text }];
