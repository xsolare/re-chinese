...
<div>
  <span type="tab">
    ...
    <span type="h" p="le">了</span><span type="h" p="zhe">着</span><span type="h" p="guò">过</span>. Если мы хотим задать вопрос с помощью повторения глагола,
  ...
  <br />
  <span type="tab">Сказать «не нужно» можно двумя путями:</span>
  <div type="example">
  ...
  <span type="tab">В этих значениях «не хочу, не нуждаюсь» будет <span type="h" p="bùyào">不要</span></span>
  ...
  <span type="tab">Этот глагол мы используем, когда говорим о возможности что-то сделать (физически или по обстоятельствам)</span>
  <br />
  <div type="example">
  ...
  <span type="tab">Также мы можем использовать <span type="h" p="néng">能</span>, чтобы спросить разрешения. В таких случаях, в вопросах и отрицаниях ставится <span type="h" p="néng">能</span>, а в утверждениях — <span type="h" p="kěyǐ">可以</span></span>
  <div type="example">
  ...
  <span type="tab">Этот глагол используется, когда мы спрашиваем разрешения и  даем советы.</span>
  <div type="example">
  ...
  <span type="tab">Обратите внимание, что отрицание для <span type="h" p="kěyǐ － bùnéng">可以 － 不能</span>.
  ...
  <span type="tab">Именно «уметь в результате обучения».</span>
  <div type="example">
  ...
  <br />
  <span type="tab">Второе значение глагола <span type="h" p="huì">会</span> - возможность какого-то события.</span>
  <div type="example">
  ...
  <span type="tab">Обычно используется в советах врачей, учителей, родителей.</span>
  <div type="example">
  ...
  <span type="tab">Означает сильное желание или готовность что-то сделать.</span>
  <div type="example">
  ...
  <span type="tab">Отрицательная форма - <span type="h" p="bùbì">不必</span> или <span type="h" p="bùyòng">不用</span> </span>
  <div type="example">
  ...
  <span type="tab">Менее официальный характер, чем, например, у 必须. Он указывает, что действие надо совершить по объективным (к экзамену надо готовиться) и субъективным (нравственным) причинам.</span>
  <div type="example">
    <span type="h" p="miànbāo, shuǐ, dìtú dū zhǔnbèihǎo liǎo，wǒmen huán xūyào dài shíme" t="Я взял хлеб, воду и карту. Что еще необходимо взять с собой?">面包、水、地图都准备好了，我们还需要带什么?</span> <br />
