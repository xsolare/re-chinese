...
<div>
  <span type="text">&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <span fixed="0" type="h" t="понимать" p="le">了</span>
    <span fixed="0" type="h" t="носить" p="zhe">着</span>
    <span fixed="0" type="h" t="проходить" p="guò">过</span>. 
  ...
  <span type="text">
    Кроме того 
    <span fixed="0" type="h" p="xiǎng" t="хотеть">想</span> 
    - прекрасен тем, что перед ним могут стоять слова типа 
    <span fixed="0" type="h" p="hěn" t="очень">很</span> 
    и
  ...
  <span type="text">
    Первое его значение- также «собираться». Но, в отличие от 
    <span fixed="0" type="h" p="xiǎng" t="хотеть">想</span>
    , говорящий не просто хочет поехать куда-то, но уже запланировал маршрут и
    купил билет.
  </span>
  <br />
  ...
  <br />
  <span type="text">
    Обратите внимание, что часто отрицательные и утвердительные формы модальных глаголов не совпадают по значению. Например,  <span type="h" p="bùyào">不要</span>
    ...
    глаголы — 
    <span fixed="0" type="h" p="bù xiǎng，bù yuànyì"Не хочу, не хочу">不想，不愿意</span> 
    Второе значение 
    <span fixed="0" type="h" p="yào" t="хотеть">要</span> 
    — нужно, должно. Например, «студенты должны
  ...
  <br />
  <span type="text">Сказать «не нужно» можно двумя путями:</span>
  <div type="example">
  ...
  <span type="warn">
    ...
    <span type="h" p="wǒ yào yī pán gōngbǎojī dīng" t="не одну порцию курицы Гунбао.">我要一盘宫保鸡丁</span> <span type="h" p="yào" t="хотеть">要</span> «заказывать», после него стоит существительное. <br />
    <span type="h" p="zhè běn hàné cídiǎn wǒ huán yào，bùnéng huángěi nǐ" t="тот китайско-русский словарь мне еще нужен, не могу тебе вернуть.">这本汉俄词典我还要，不能还给你</span> <span type="h" p="yào" t="хотеть">要</span> - «необходим», к нему относится существительное «словарь».<br />
  </span>

  <span type="text">
    В этих значениях «не хочу, не нуждаюсь» будет 
    <span fixed="0" type="h" p="bùyào" t="не хочу, не нуждаюсь">不要</span>
  </span>
  <div type="example">
    <span type="h" p="wǒ bùyào kāfēi，xièxiè" t="Спасибо, мне не нужно кофе.">我不要咖啡，谢谢</span>
  </div>

  <br />
  <span type="text">
    <em>Сравните с употреблением модального глагола:</em> <br />
    A: <span type="h" p="nǐmen dàxuéshēng yào xuéxí shùxué mǎ" t="Вы, студенты, должны учить математику?">你们大学生要学习数学吗?</span> <br />
    B: <span type="h" p="wǒ shì gè wàiyǔxì de xuéshēng，bù yòngshàng shùxué kè" t="Я студент факультета иностранных языков, мне не надо учить математику.">我是个外语系的学生，不用上数学课</span> <br />
  </span>

  <hr />
  
  <div type="h" index="3" p="néng" t="мочь">能</div>
  <span type="text">Этот глагол мы используем, когда говорим о возможности что-то сделать (физически или по обстоятельствам)</span>
  <br />
  <div type="example">
  ...
  <br />
  <span type="text">Также мы можем использовать 
    <span fixed="0" type="h" p="néng" t="мочь">能</span>
    , чтобы спросить разрешения. В таких случаях, в вопросах и отрицаниях ставится 
    <span fixed="0" type="h" p="néng" t="мочь">能</span>
    , а в утверждениях — 
  ...
  <span type="text">Этот глагол используется, когда мы спрашиваем разрешения и  даем советы.</span>
  <div type="example">
  ...
  <span type="text">
    Обратите внимание, что отрицание для 
    <span fixed="0" type="h" p="kěyǐ － bùnéng" t="могу－не могу">可以 － 不能</span>. 
    Дело в том, что 
    <span fixed="0" type="h" p="bùkěyǐ" t="нельзя">不可以</span> 
    - довольно редкая форма, используется для запрета (по общепринятым нормам поведения) или резкого отказа. 
    Не думаю, что человек, спросивший разрешения войти, заслужил эмоциональное 
    <span fixed="0" type="h" p="bùkěyǐ" t="нельзя">不可以</span>
  </span>
  ...
  <span type="text">Именно «уметь в результате обучения».</span>
  <div type="example">
  ...
  <br />
  <span type="text">Второе значение глагола 
    <span fixed="0" type="h" p="huì" t="мочь">会</span> 
    - возможность какого-то события.
  </span>
  <div type="example">
  ...
  <span type="text">Обычно используется в советах врачей, учителей, родителей.</span>
  <div type="example">
  ...
  <span type="text">Означает сильное желание или готовность что-то сделать.</span>
  <div type="example">
  ...
  <br />
  <span type="text">Отрицательная форма - 
    <span fixed="0" type="h" p="bùbì" t="не нужно">不必</span> 
    или 
    <span fixed="0" type="h" p="bùyòng" t="не надо">不用</span> 
  </span>
  <div type="example">
  ...
  <span type="text">Менее официальный характер, чем, например, у 
    <span fixed="0" type="h" p="bìxū" t="должен">必须</span>
    . Он указывает, что действие надо совершить по объективным (к экзамену надо готовиться) и субъективным (нравственным) причинам.
  </span>
  <div type="example">
    <span type="h" p="miànbāo, shuǐ, dìtú dū zhǔnbèihǎo liǎo，wǒmen huán xūyào dài shíme" t="Я взял хлеб, воду и карту. Что еще необходимо взять с собой?">面包、水、地图都准备好了，我们还需要带什么?</span> <br />
  ...
  <br />
  <span type="warn">
    Обратите внимание, что отрицательная форма здесь тоже <span type="h" p="bùbì(bùyòng)" t="нет необходимости">不必(不用)</span>.
  </span>
