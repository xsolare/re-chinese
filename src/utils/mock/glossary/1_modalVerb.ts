...
<div>
  ...
  <span type="text">В этих значениях «не хочу, не нуждаюсь» будет <span type="h" p="bùyào">不要</span></span>
  ...
  <br />
  <span type="text">Также мы можем использовать <span type="h" p="néng">能</span>, чтобы спросить разрешения. В таких случаях, в вопросах и отрицаниях ставится <span type="h" p="néng">能</span>, а в утверждениях — <span type="h" p="kěyǐ">可以</span></span>
  <div type="example">
  ...
  <span type="text">
    Обратите внимание, что отрицание для <span type="h" p="kěyǐ － bùnéng">可以 － 不能</span>. 
  ...
  <br />
  <span type="text">Второе значение глагола <span type="h" p="huì">会</span> - возможность какого-то события.</span>
  <div type="example">
  ...
  <br />
  <span type="text">Отрицательная форма - <span type="h" p="bùbì">不必</span> или <span type="h" p="bùyòng">不用</span> </span>
  <div type="example">
  ...
  <span type="text">Менее официальный характер, чем, например, у 必须. Он указывает, что действие надо совершить по объективным (к экзамену надо готовиться) и субъективным (нравственным) причинам.</span>
  <div type="example">
    <span type="h" p="miànbāo, shuǐ, dìtú dū zhǔnbèihǎo liǎo，wǒmen huán xūyào dài shíme" t="Я взял хлеб, воду и карту. Что еще необходимо взять с собой?">面包、水、地图都准备好了，我们还需要带什么?</span> <br />
