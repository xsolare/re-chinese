import { BaseStore, IBaseParams, IBaseStoreParams, IBaseValidator } from "../base.store";
...
export interface IFormStoreParams extends Omit<IBaseParams, "isVisible">, IFormStoreParamsExtended {
...
export class FormStore extends BaseStore {
    ...
    getControlStores = (): BaseStore[] => Array.from(this._childStores.values()).filter((store) => store instanceof ControlStore);    
}